...
- `obsidian-addon`: optional `obsidian-compat`
...
- `obsidian-addon` is optional and intentionally light. It should not make Obsidian a required runtime or source of truth.
