...
- до включения branch protection относиться к `main` как к защищённой ветке по договорённости
...
Пока GitHub branch protection недоступна для этого приватного репозитория на текущем тарифе, использовать такое соглашение:
...
Это временная организационная замена технической защиты ветки.
